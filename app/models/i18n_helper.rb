class I18nHelper
  TRANSLATIONS = {
    "en" => {
      ...
      demo_banner: "Showing demo data \u2014 add your OpenWeather API key for real conditions.",
    ...
    "ro" => {
      ...
      demo_banner: "Date demonstrative \u2014 adaug\u0103 cheia API OpenWeather pentru date reale.",
